...
const CourseDetail = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useQuery(() => servicesCourse.getCoursesBySlug(slug), [slug]);

  return (
    <main className="mainwrapper coursedetailpage">
      <AccordionItem courseDetail={courseDetail} />
      {courseDetail && <CourseHero courseDetail={courseDetail} />}
      <ContentDetail courseDetail={courseDetail} />
      <HomeFeatured />
